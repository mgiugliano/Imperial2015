...
const double gammak = 10.0;	// [pS]
const double gkbar = 0.036;	// [S/cm^2]
...
int main(int argc, char *argv[]) {
	...
	options opt;
	microscopic micro(seed,area,gammak,gkbar);
	effective eff(seed,area,gammak,gkbar);
	fox fx(seed,area,gammak,gkbar);
